...
const LoginIndex = () =>{
  ...
  return (
    <div className="max-w-screen-phoneXS phoneLG:max-w-screen-phoneLG phone:max-w-screen-phone w-full px-4 pt-6 pb-6 bg-gray-50">
        <div className={'flex flex-col items-center justify-center gap-4'}>
          ...
          <button className="py-2 px-8 text-xl text-white bg-blue-400 rounded-lg">Giriş Yap</button>
