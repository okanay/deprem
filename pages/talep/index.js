...
import CostumInputNotFormik from "../../components/UI/CostumInputNotFormik";
...
const Talep = () => {
  ...
  return (
    <div
      className={
        "bg-gray-50 max-w-screen-phoneXS phoneLG:max-w-screen-phoneLG phone:max-w-screen-phone w-full m-20 my-8 mx-auto py-8"
      }
    >
      {/* UYARI - BASLIK  */}
      <div className={"px-4"}>
      ...
      <div className="flex flex-col justify-between items-center mt-11 gap-4">
        ...
        <div
          className={
            "flex flex-row justify-between items-center text-xs w-full text-blue-500 px-4"
          }
        >
          {/*  SOL TARAF */}
          <button
